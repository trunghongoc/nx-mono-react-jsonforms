...
const horizontalLayoutClasses = [
  ...
  '[&>button:first-child]:!rounded-l-border',
  '[&>button:last-child]:!rounded-r-border',
  '[&>button:only-child]:!rounded-border',
  '[&>button:hover]:z-[1]',
...
const verticalLayoutClasses = [
  ...
  '[&>button:first-child]:!rounded-t-border',
  '[&>button:last-child]:!rounded-b-border',
  '[&>button:only-child]:!rounded-border',
  '[&>button:hover]:z-[1]',
  '[&>button:focus-visible]:z-[1]',
  '[&>button:active]:z-[1]',
